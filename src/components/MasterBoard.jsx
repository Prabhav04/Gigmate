...
import { Save, Plus, Trash2, Play, Circle, GripVertical } from 'lucide-react';
                            ...
                            {songs.map((song, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        <div className="pt-3 text-slate-600 cursor-grab active:cursor-grabbing hover:text-slate-400" title="Drag to reorder">
